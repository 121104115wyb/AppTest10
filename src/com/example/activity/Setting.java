...
import main.Common;
import main.MWebSocket;
import main.Utils;

import static main.Common.PostUserKeyUrl;
...
//            {"stat":false,"message":"imei重复或数据库异常","code":-102,"data":null}
    ...
    void changeUrl(Boolean chencked) {
        ...
        if (chencked) {
            //正式地址
            Common.PostUserKeyUrl = "http://182.61.178.193/app/addevice";
            writeurl(Common.WebSocketUrl);
        } else {
            //测试地址
            Common.PostUserKeyUrl = "http://xuanlv2.natapp1.cc/app/addevice";
